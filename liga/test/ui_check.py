...
def login(pg, email, name):
    pg.click('nav button[data-v="group"]'); pg.fill('#inName', name); pg.press('#inName', 'Tab'); pg.wait_for_timeout(200)
...
with sync_playwright() as p:
    ...
    B.click('nav button[data-v="group"]'); B.fill('#inName', 'Ben'); B.press('#inName', 'Tab'); B.click('nav button[data-v="liga"]')
    ...
    A.click('nav button[data-v="tacho"]'); A.wait_for_timeout(500)
    A.evaluate("LigaUI.tachoTick()"); A.wait_for_timeout(600)
    row = A.inner_text('#ligaRow')
    check('Tacho zeigt Liga-Zeile mit Nachbarn', A.locator('#ligaRow').is_visible() and 'Du' in row and ('Ben' in row), row)
    shot(A, '7-tacho')
    ...
    B.evaluate("LigaUI._tachoRender({dist: 40000, moving: 1})"); rb2 = B.inner_text('#ligaRow')
    ...
    A.click('[data-act="tab"][data-tab="ziele"]'); A.wait_for_timeout(300)
    ...
    A.click('[data-act="goal-add"][data-scope="my"]'); A.wait_for_selector('#myGoals input'); A.fill('#myGoals input', '200')
    ...
    A.click('[data-act="tab"][data-tab="segmente"]'); A.wait_for_selector('[data-act="seg-add"]'); A.click('[data-act="seg-add"]'); A.wait_for_timeout(900)
    ...
    shot(A, '10-teilen')
    B.click('.lg-league'); B.wait_for_selector('.lg-tabs'); B.click('[data-act="tab"][data-tab="geteilt"]'); B.wait_for_selector('[data-act="ghost"]')
    ...
    if A.locator('[data-act="home"]').count(): A.click('[data-act="home"]')
    A.wait_for_selector('[data-act="logout"]'); A.click('[data-act="logout"]'); A.wait_for_selector('#lgEmail')
    ...
    A.click('[data-act="devices"]'); A.wait_for_selector('.lg-devs'); n = A.locator('.lg-devs .lg-row').count()
    ...
    B.click('[data-act="home"]') if B.locator('[data-act="home"]').count() else None
    B.wait_for_selector('[data-act="delete-account"]'); B.click('[data-act="delete-account"]'); B.wait_for_selector('#lgEmail')
